  ...
  const Heading = () => (
    <div className="relative z-10 my-12 flex flex-col items-center justify-center gap-4">
      <div className="flex w-full flex-col items-start justify-center space-y-4 md:items-center">
        <div className="mb-2 inline-block rounded-full bg-purple-100 px-2 py-[0.20rem] text-xs font-medium uppercase text-purple-500 dark:bg-red-200">
          {' '}
          Pricing
        </div>
      ...
      <div className="flex items-center justify-center gap-3">
        <button
          ...
          className={cn(
            ...
            billingCycle === 'M'
              ? 'relative bg-purple-500 text-white '
  ...
  const PricingCards = () => (
    <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-8 lg:flex-row lg:gap-4">
      {pricingPlans.map((plan, index) => (
        ...
        >
          <p className="mb-1 mt-0 text-sm font-medium uppercase text-purple-500">
            {plan.name}
          </p>
          ...
          <div className="mb-8 overflow-hidden">
            ...
            <motion.button
              ...
              className="mt-8 w-full rounded-lg bg-purple-500 py-2 text-sm font-medium text-white hover:bg-red-500/90"
            >
              Get Started
            </motion.button>
          </div>
...
const BackgroundShift = ({ shiftKey }: { shiftKey: string }) => (
  <motion.span
    key={shiftKey}
    layoutId="bg-shift"
    className="absolute inset-0 -z-10 rounded-lg bg-purple-500"
